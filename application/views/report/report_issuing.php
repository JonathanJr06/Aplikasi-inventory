<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box">
            <div class="box-body">
                <form method="get" action="<?php echo base_url('index.php/report/report_issuing') ?>">
                    <div class="row">
                    ...
                    if (isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                        echo '<a href="' . base_url('index.php/report/report_issuing') . '" class="btn btn-default">RESET</a>';
                    ?>
                </form>
