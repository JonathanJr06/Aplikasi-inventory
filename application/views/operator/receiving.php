                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover" id="dataTable">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($receiving->result_array() as $row) {
                            ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= $row['date'] ?></td>
                                    ...
                                    <td>
                                        <!-- <a href="<?= base_url('index.php/operator/receiving/detail_receiving/') . $row['id'] ?>" class="btn btn-info btn-xs">
                                            <div class="fa fa-eye"></div>Tambah Barang
                                        </a> -->
                                        <button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#editData<?= $row['id'] ?>">
                                            <div class="fa fa-edit"></div>Edit
                                        </button>
                                        <a href="<?= base_url('index.php/operator/receiving/delete/') . $row['id'] ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Data yang berhubungan akan terhapus juga!">
