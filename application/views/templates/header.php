...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url('assets') ?>/logo/jagodigital.png">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?= base_url('index.php/admin/profil') ?>" class="btn btn-default btn-flat">
                      <div class="fa fa-user"></div> <span class="hidden-xs">Profile</span>
                    </a>
                  </div>
                  <div class="pull-right">
                    <a href="<?= base_url('index.php/home/logout') ?>" class="btn btn-default btn-flat tombol-yakin" data-isidata="Ingin keluar dari sistem ini?">
                      <div class="fa fa-sign-out"></div> <span class="hidden-xs">Sign out</span>
                    </a>
                  </div>
                </li>
              </ul>
